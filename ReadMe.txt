...
Sample Model
Hiyori Momose (video version) - PRO

============================================================

　This model can be used to learn about Form Animation.

　A single anime scene was reproduced here using the Hiyori model.
　Form Animation is used to expand the model range of movement, and create free motion independent of the parameters.
...
　hiyori_movie_pro_t03
　2023/03/08 　Modified description of parameter settings.
